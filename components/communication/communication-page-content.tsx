...
import type { Message, Task } from "./communication-types"
export type { TeamMember, Message, TaskStatus, TaskDisciplina, TaskTipo, Task } from "./communication-types"
export { teamMembers } from "./communication-types"
